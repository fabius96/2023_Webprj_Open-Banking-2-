	...
	<div class="section1">
		...
		<table id="product-table">
			...
			<tbody>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '첫급여 기업통장')">첫급여 기업통장</a></td>
				</tr>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '기업닷컴통장')">기업닷컴통장</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
					<td><a href="#" onclick="passText(this, '기업 첫거래우대 정기예금')">기업 첫거래우대 정기예금</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
