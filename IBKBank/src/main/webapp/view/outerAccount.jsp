...
$(document).ready(function(){
    $.ajax({
        type: 'GET',
        url: '/gwanjung/outer-my-accounts',
        data: {  'bankName': '관중',
               ...
               $("#loading").show();
                              ...
                              success : function(response) {
                                 ...
                                 for (let i = 0; i < accountList.length; i++) {
                                    ...
                                    accountInfo
                                          .append(
                                                "<span class='account-bank'>은행명: "
                                                      + accountList[i].bankCode
                                                      + "</span>")
                                          .append(
                                                "<span class='account-number'>계좌번호: "
                                                      + accountList[i].accountNumber
                                                      + "</span>");
...
<body>
   ...
   <div class="section1">
      ...
      <div class="account-info">
         ...
         <div class="select_bank">
            <div class="btn-group" role="group" aria-label="Select Bank">
               ...
               <!-- 관중은행 기준 -->
               <button type="button" class="btn btn-secondary"
                  onclick="location.href='innerAccount.jsp'">기업은행</button>
               <button type="button" class="btn btn-secondary"
      ...
      <div id="loading" class="center-screen" style="display: none;">
				        <img src="../img/Loading.gif" alt="../img/IBK.jpg" />
	  </div>
