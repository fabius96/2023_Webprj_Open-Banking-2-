	...
	<div class="section1">
		...
		<table id="product-table">
			...
			<tbody>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '첫급여 농협통장')">첫급여 농협통장</a></td>
				</tr>
				<tr>
					<td>입출금상품</td>
					<td><a href="#" onclick="passText(this, '농협닷컴통장')">농협닷컴통장</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
					<td><a href="#" onclick="passText(this, '농협 첫거래우대 정기예금')">농협 첫거래우대 정기예금</a></td>
				</tr>
				<tr>
					<td>예금적금상품</td>
