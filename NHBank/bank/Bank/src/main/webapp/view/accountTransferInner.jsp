    ...
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                selectElement.change();  // Trigger change to display balance for initial selection
            },
...
<body>
    <div class="header">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <c:url var="logoUrl" value="/img/NH.jpg" />
	...
	<div class="section1">
			...
			<div class="select_account">
				<div class="btn-group" role="group" aria-label="Select Bank">
					...
					<button type="button" class="btn btn-secondary"
						onclick="location.href='accountTransferInner.jsp'">농협은행
						계좌이체</button>
					<button type="button" class="btn btn-secondary"
		...
		<div class="container">
			...
			<div class="form-group">
				...
				<select class="form-control" id="bank-select" name="bankCode1">
					<option value="농협">농협</option>
				</select>
			</div>
			
			<div class="form-group">
			    <label for="account-select">계좌번호 선택</label>
			    <select class="form-control" id="account-select" name="accountNumber1"></select>
			</div>
			<div class="form-group">
				<label class="balance-label" id="balance-label">잔액:</label>
				<span id="balance">원</span>
			</div>
			<div class="form-group">
				<label for="transfer-input">송금액</label>
				<input type="text" class="form-control" id="transfer-input" name="amount">
			</div>
			<div class="form-group">
				<label for="password-input">계좌 비밀번호</label>
				<input type="password" class="form-control" id="password-input">
			</div>
			<div class="form-group">
				<label for="recipient-bank-select">상대은행 선택</label>
				<select class="form-control" id="recipient-bank-select" name="bankCode2">
			...
			<div class="form-group">
				<label for="recipient-account-input">상대계좌</label><div id="data"></div>
				<input type="text" class="form-control" id="recipient-account-input" name="accountNumber2">
			<button onclick="sendInfo()">예금주명 확인</button></div>
			<div class="form-group">
				<label for="recipient-account-input">내용</label>
				<input type="text" class="form-control" id="recipient-account" name="content">
			</div>
	...
	<footer class="BankFooter">
		<div class="BankFooterContent">
			...
			<p class="FooterDescription">농협은행오픈뱅킹입니다.</p>
		</div>
