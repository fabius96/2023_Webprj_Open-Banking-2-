...
@WebServlet({"/accounts", "/username", "/my-accounts", "/registrate",
        "/view/accountInfo/insertAccount", "/balance", "/my-inner-accounts", "/outer-my-accounts",
...
public class AccountInfoRequestController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command.equals("/accounts")) {
            ...
            String url =
                    "http://3.39.230.202/openapi/account-info?personalIdNumber=" + encodedIdNumber;
            ...
            String url = "http://3.39.230.202/openapi/outer-my-account-info?bankName=" + bankName
            ...
            accountInfos =
                    accountInfos.stream().sorted(Comparator.comparing(AccountInfoDTO::getBankCode))
            ...
            String url = "http://3.39.230.202/openapi/username?accountNumber=" + accountNumber
                    + "&bankCode=" + bankCode;
            ...
            String url = "http://3.39.230.202/openapi/my-bank-accounts?bankCode=" + bankCode
                    + "&personalIdNumber=" + encodedIdNumber;
            ...
            String url = "http://3.39.230.202/openapi/outer-balance?accountNumber=" + accountNumber
                    + "&bankCode=" + bankCode;
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command.equals("/registrate")) {
            ...
            URL url = new URL("http://3.39.230.202/openapi/registrate");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command.equals("insertAccount")) {
            ...
            viewPage = "/yurim/view/mainHana.jsp";
