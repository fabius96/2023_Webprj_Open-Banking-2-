	...
	<div class="section1">
		...
		<table id="product-table">
			...
			<tbody>
				<tr>
					<td>입출금상품</td>
					<td><span onclick="passText(this, '영하나플러스 통장')">영하나플러스
							통장 </span></td>
				</tr>
				<tr>
					<td>입출금상품</td>
				...
				<tr>
					<td>입출금상품</td>
					<td><span onclick="passText(this, '하나 취업이룸 통장')">하나
							취업이룸 통장</span></td>
				</tr>
				<tr>
					<td>예금상품</td>
					<td><span onclick="passText(this, '3·6·9 정기예금')">3·6·9
							정기예금</span></td>
				</tr>
				<tr>
					<td>예금상품</td>
					<td><span onclick="passText(this, '행복knowhow 연금예금')">행복knowhow
							연금예금</span></td>
				</tr>
				<tr>
					<td>예금상품</td>
					<td><span onclick="passText(this, '고단위 플러스(금리연동형)')">고단위
							플러스(금리연동형)</span></td>
				</tr>
				<tr>
					<td>적금상품</td>
					<td><span onclick="passText(this, '하나 청년도약계좌')">하나
							청년도약계좌</span></td>
				</tr>
				<tr>
					<td>적금상품</td>
				...
				<tr>
					<td>적금상품</td>
					<td><span onclick="passText(this, '급여하나 월복리 적금')">급여하나
							월복리 적금</span></td>
				</tr>
		...
		<script>
			function passText(element, text) {
				...
				window.location.href = "/yurim/view/makeAccount.jsp?text="
