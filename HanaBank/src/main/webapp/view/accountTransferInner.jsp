...
function sendInfo() {
    ...
    xhr.open("GET", '/yurim/username?bankCode2=' + encodeURIComponent(bankCode2) + '&accountNumber2=' + encodeURIComponent(accountNumber2));
    xhr.onload = function() {
        if (xhr.status == 200) {
            // 서블릿에서 받은 응답을 출력
