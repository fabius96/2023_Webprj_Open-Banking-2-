...
//                response.getWriter().write("PUT request succeeded.");
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      if (command.equals("/transfer-info")) {
         ...
         String url = "http://3.39.230.202/openapi/transfer-info?accountNumber=" + accountNumber + "&bankCode="
               + bankCode;
         ...
         resp.getWriter().write(gson.toJson(accountTransferInfos));
          ...
          String url = "http://3.39.230.202/openapi/outer-transfer-info?bankName=" + bankName + "&personalIdNumber="
                + encodedIdNumber;
